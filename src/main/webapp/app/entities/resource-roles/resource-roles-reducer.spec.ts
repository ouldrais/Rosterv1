...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESOURCEROLES_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESOURCEROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESOURCEROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESOURCEROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESOURCEROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESOURCEROLES actions', async () => {
      const expectedActions = [
        {
