    ...
    <Row>
      <Col md="8">
        <h2 data-cy="shiftDetailsHeading">
          <Translate contentKey="rosterv1App.shift.detail.title">Shift</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="key">
              <Translate contentKey="rosterv1App.shift.key">Key</Translate>
            </span>
          </dt>
          ...
          <dt>
            <span id="type">
              <Translate contentKey="rosterv1App.shift.type">Type</Translate>
            </span>
          </dt>
