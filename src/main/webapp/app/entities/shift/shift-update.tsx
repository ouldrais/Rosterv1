  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rosterv1App.shift.home.createOrEditLabel" data-cy="ShiftCreateUpdateHeading">
            <Translate contentKey="rosterv1App.shift.home.createOrEditLabel">Create or edit a Shift</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('rosterv1App.shift.key')} id="shift-key" name="key" data-cy="key" type="text" />
              <ValidatedField
                label={translate('rosterv1App.shift.shiftStart')}
                id="shift-shiftStart"
                name="shiftStart"
                data-cy="shiftStart"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('rosterv1App.shift.shiftEnd')}
                id="shift-shiftEnd"
                name="shiftEnd"
                data-cy="shiftEnd"
                type="datetime-local"
                placeholder="YYYY-MM-DD HH:mm"
              />
              <ValidatedField label={translate('rosterv1App.shift.type')} id="shift-type" name="type" data-cy="type" type="text" />
