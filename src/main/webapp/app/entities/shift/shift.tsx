  ...
  return (
    <div>
      <h2 id="shift-heading" data-cy="ShiftHeading">
        <Translate contentKey="rosterv1App.shift.home.title">Shifts</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="rosterv1App.shift.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/shift/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterv1App.shift.home.createLabel">Create new Shift</Translate>
          </Link>
        </div>
      </h2>
        ...
        {shiftList && shiftList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="rosterv1App.shift.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('key')}>
                  <Translate contentKey="rosterv1App.shift.key">Key</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('key')} />
                </th>
                <th className="hand" onClick={sort('shiftStart')}>
                  <Translate contentKey="rosterv1App.shift.shiftStart">Shift Start</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('shiftStart')} />
                </th>
                <th className="hand" onClick={sort('shiftEnd')}>
                  <Translate contentKey="rosterv1App.shift.shiftEnd">Shift End</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('shiftEnd')} />
                </th>
                <th className="hand" onClick={sort('type')}>
                  <Translate contentKey="rosterv1App.shift.type">Type</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('type')} />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="rosterv1App.shift.home.notFound">No Shifts found</Translate>
            </div>
          )
        )}
      </div>
