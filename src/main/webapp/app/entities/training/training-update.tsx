  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rosterv1App.training.home.createOrEditLabel" data-cy="TrainingCreateUpdateHeading">
            <Translate contentKey="rosterv1App.training.home.createOrEditLabel">Create or edit a Training</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('rosterv1App.training.key')} id="training-key" name="key" data-cy="key" type="text" />
              <ValidatedField
                label={translate('rosterv1App.training.description')}
