  ...
  return (
    <div>
      <h2 id="training-heading" data-cy="TrainingHeading">
        <Translate contentKey="rosterv1App.training.home.title">Trainings</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="rosterv1App.training.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/training/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterv1App.training.home.createLabel">Create new Training</Translate>
          </Link>
        </div>
      </h2>
        ...
        {trainingList && trainingList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="rosterv1App.training.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('key')}>
                  <Translate contentKey="rosterv1App.training.key">Key</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('key')} />
                </th>
                <th className="hand" onClick={sort('description')}>
                  <Translate contentKey="rosterv1App.training.description">Description</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="rosterv1App.training.home.notFound">No Trainings found</Translate>
            </div>
          )
        )}
      </div>
