...
const EntitiesMenu = () => {
  return (
    <>
      ...
      <MenuItem icon="asterisk" to="/resource-roles">
        <Translate contentKey="global.menu.entities.resourceRoles" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/ref-rotation">
        <Translate contentKey="global.menu.entities.refRotation" />
      </MenuItem>
