  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rosterv1App.resource.home.createOrEditLabel" data-cy="ResourceCreateUpdateHeading">
            <Translate contentKey="rosterv1App.resource.home.createOrEditLabel">Create or edit a Resource</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('rosterv1App.resource.key')} id="resource-key" name="key" data-cy="key" type="text" />
              <ValidatedField
                label={translate('rosterv1App.resource.firstName')}
              ...
              />
              <ValidatedField
                label={translate('rosterv1App.resource.lastName')}
              ...
              />
              <ValidatedField
                label={translate('rosterv1App.resource.teamRole')}
              ...
              />
              <ValidatedField
                label={translate('rosterv1App.resource.exchangeAllowed')}
                ...
                type="checkbox"
              />
              <ValidatedField id="resource-team" name="team" data-cy="team" label={translate('rosterv1App.resource.team')} type="select">
                <option value="" key="0" />
                {teams
