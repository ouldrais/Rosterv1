  ...
  return (
    <div>
      <h2 id="resource-heading" data-cy="ResourceHeading">
        <Translate contentKey="rosterv1App.resource.home.title">Resources</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="rosterv1App.resource.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/resource/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterv1App.resource.home.createLabel">Create new Resource</Translate>
          </Link>
        </div>
      </h2>
        ...
        {resourceList && resourceList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="rosterv1App.resource.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('key')}>
                  <Translate contentKey="rosterv1App.resource.key">Key</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('key')} />
                </th>
                <th className="hand" onClick={sort('firstName')}>
                  <Translate contentKey="rosterv1App.resource.firstName">First Name</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('firstName')} />
                </th>
                <th className="hand" onClick={sort('lastName')}>
                  <Translate contentKey="rosterv1App.resource.lastName">Last Name</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('lastName')} />
                </th>
                <th className="hand" onClick={sort('teamRole')}>
                  <Translate contentKey="rosterv1App.resource.teamRole">Team Role</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('teamRole')} />
                </th>
                <th className="hand" onClick={sort('exchangeAllowed')}>
                  <Translate contentKey="rosterv1App.resource.exchangeAllowed">Exchange Allowed</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('exchangeAllowed')} />
                </th>
                <th>
                  <Translate contentKey="rosterv1App.resource.team">Team</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="rosterv1App.resource.home.notFound">No Resources found</Translate>
            </div>
          )
        )}
      </div>
