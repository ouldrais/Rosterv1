  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rosterv1App.position.home.createOrEditLabel" data-cy="PositionCreateUpdateHeading">
            <Translate contentKey="rosterv1App.position.home.createOrEditLabel">Create or edit a Position</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('rosterv1App.position.key')} id="position-key" name="key" data-cy="key" type="text" />
              <ValidatedField
                label={translate('rosterv1App.position.leadership')}
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('rosterv1App.position.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
