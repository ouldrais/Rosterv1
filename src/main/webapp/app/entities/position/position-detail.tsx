    ...
    <Row>
      <Col md="8">
        <h2 data-cy="positionDetailsHeading">
          <Translate contentKey="rosterv1App.position.detail.title">Position</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="key">
              <Translate contentKey="rosterv1App.position.key">Key</Translate>
            </span>
          </dt>
          ...
          <dt>
            <Translate contentKey="rosterv1App.position.department">Department</Translate>
          </dt>
