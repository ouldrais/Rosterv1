  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rosterv1App.team.home.createOrEditLabel" data-cy="TeamCreateUpdateHeading">
            <Translate contentKey="rosterv1App.team.home.createOrEditLabel">Create or edit a Team</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="team-id"
                  label={translate('rosterv1App.team.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField label={translate('rosterv1App.team.key')} id="team-key" name="key" data-cy="key" type="text" />
