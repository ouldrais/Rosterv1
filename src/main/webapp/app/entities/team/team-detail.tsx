    ...
    <Row>
      <Col md="8">
        <h2 data-cy="teamDetailsHeading">
          <Translate contentKey="rosterv1App.team.detail.title">Team</Translate>
        </h2>
        <dl className="jh-entity-details">
          <dt>
            <span id="key">
              <Translate contentKey="rosterv1App.team.key">Key</Translate>
            </span>
          </dt>
          <dd>{teamEntity.key}</dd>
          <dt>
            <span id="id">
              <Translate contentKey="rosterv1App.team.id">Id</Translate>
            </span>
          </dt>
          <dd>{teamEntity.id}</dd>
        </dl>
