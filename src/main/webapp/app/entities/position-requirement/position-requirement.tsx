  ...
  return (
    <div>
      <h2 id="position-requirement-heading" data-cy="PositionRequirementHeading">
        <Translate contentKey="rosterv1App.positionRequirement.home.title">Position Requirements</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="rosterv1App.positionRequirement.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="rosterv1App.positionRequirement.home.createLabel">Create new Position Requirement</Translate>
          </Link>
        </div>
      </h2>
        ...
        {positionRequirementList && positionRequirementList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="rosterv1App.positionRequirement.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('mandatoty')}>
                  <Translate contentKey="rosterv1App.positionRequirement.mandatoty">Mandatoty</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('mandatoty')} />
                </th>
                <th>
                  <Translate contentKey="rosterv1App.positionRequirement.training">Training</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="rosterv1App.positionRequirement.position">Position</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="rosterv1App.positionRequirement.home.notFound">No Position Requirements found</Translate>
            </div>
          )
        )}
      </div>
