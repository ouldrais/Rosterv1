...
export const PositionRequirementDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rosterv1App.positionRequirement.delete.question">
        <Translate contentKey="rosterv1App.positionRequirement.delete.question" interpolate={{ id: positionRequirementEntity.id }}>
