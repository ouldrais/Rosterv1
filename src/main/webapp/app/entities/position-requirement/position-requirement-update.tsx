  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rosterv1App.positionRequirement.home.createOrEditLabel" data-cy="PositionRequirementCreateUpdateHeading">
            <Translate contentKey="rosterv1App.positionRequirement.home.createOrEditLabel">Create or edit a PositionRequirement</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('rosterv1App.positionRequirement.mandatoty')}
              ...
              <ValidatedField
                ...
                name="training"
                data-cy="training"
                label={translate('rosterv1App.positionRequirement.training')}
                type="select"
              >
                <option value="" key="0" />
                {trainings
              ...
              <ValidatedField
                ...
                name="position"
                data-cy="position"
                label={translate('rosterv1App.positionRequirement.position')}
                type="select"
              >
                <option value="" key="0" />
                {positions
