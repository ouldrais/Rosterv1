    ...
    <Row>
      <Col md="8">
        <h2 data-cy="positionRequirementDetailsHeading">
          <Translate contentKey="rosterv1App.positionRequirement.detail.title">PositionRequirement</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="rosterv1App.positionRequirement.training">Training</Translate>
          </dt>
          <dd>{positionRequirementEntity.training ? positionRequirementEntity.training.key : ''}</dd>
          <dt>
            <Translate contentKey="rosterv1App.positionRequirement.position">Position</Translate>
          </dt>
