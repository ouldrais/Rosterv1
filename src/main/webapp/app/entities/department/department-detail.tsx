    ...
    <Row>
      <Col md="8">
        <h2 data-cy="departmentDetailsHeading">
          <Translate contentKey="rosterv1App.department.detail.title">Department</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="rosterv1App.department.facility">Facility</Translate>
          </dt>
          <dd>{departmentEntity.facility ? departmentEntity.facility.key : ''}</dd>
        </dl>
