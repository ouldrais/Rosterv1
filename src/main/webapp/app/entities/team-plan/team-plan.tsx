  ...
  return (
    <div>
      <h2 id="team-plan-heading" data-cy="TeamPlanHeading">
        <Translate contentKey="rosterv1App.teamPlan.home.title">Team Plans</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="rosterv1App.teamPlan.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/team-plan/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterv1App.teamPlan.home.createLabel">Create new Team Plan</Translate>
          </Link>
        </div>
      </h2>
        ...
        {teamPlanList && teamPlanList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="rosterv1App.teamPlan.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th>
                  <Translate contentKey="rosterv1App.teamPlan.team">Team</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="rosterv1App.teamPlan.shift">Shift</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="rosterv1App.teamPlan.home.notFound">No Team Plans found</Translate>
            </div>
          )
        )}
      </div>
