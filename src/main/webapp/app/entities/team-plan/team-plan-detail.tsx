    ...
    <Row>
      <Col md="8">
        <h2 data-cy="teamPlanDetailsHeading">
          <Translate contentKey="rosterv1App.teamPlan.detail.title">TeamPlan</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="rosterv1App.teamPlan.team">Team</Translate>
          </dt>
          <dd>{teamPlanEntity.team ? teamPlanEntity.team.key : ''}</dd>
          <dt>
            <Translate contentKey="rosterv1App.teamPlan.shift">Shift</Translate>
          </dt>
