  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rosterv1App.teamPlan.home.createOrEditLabel" data-cy="TeamPlanCreateUpdateHeading">
            <Translate contentKey="rosterv1App.teamPlan.home.createOrEditLabel">Create or edit a TeamPlan</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField id="team-plan-team" name="team" data-cy="team" label={translate('rosterv1App.teamPlan.team')} type="select">
                <option value="" key="0" />
                {teams
              ...
              <ValidatedField
                ...
                name="shift"
                data-cy="shift"
                label={translate('rosterv1App.teamPlan.shift')}
                type="select"
              >
                <option value="" key="0" />
                {shifts
