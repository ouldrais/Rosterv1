    ...
    <Row>
      <Col md="8">
        <h2 data-cy="shiftDemandDetailsHeading">
          <Translate contentKey="rosterv1App.shiftDemand.detail.title">ShiftDemand</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="rosterv1App.shiftDemand.shift">Shift</Translate>
          </dt>
          <dd>{shiftDemandEntity.shift ? shiftDemandEntity.shift.key : ''}</dd>
          <dt>
            <Translate contentKey="rosterv1App.shiftDemand.task">Task</Translate>
          </dt>
          <dd>{shiftDemandEntity.task ? shiftDemandEntity.task.key : ''}</dd>
          <dt>
            <Translate contentKey="rosterv1App.shiftDemand.position">Position</Translate>
          </dt>
          <dd>{shiftDemandEntity.position ? shiftDemandEntity.position.key : ''}</dd>
          <dt>
            <Translate contentKey="rosterv1App.shiftDemand.department">Department</Translate>
          </dt>
