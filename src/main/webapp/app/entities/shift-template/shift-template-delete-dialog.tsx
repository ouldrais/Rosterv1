...
export const ShiftTemplateDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rosterv1App.shiftTemplate.delete.question">
        <Translate contentKey="rosterv1App.shiftTemplate.delete.question" interpolate={{ id: shiftTemplateEntity.id }}>
