  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rosterv1App.shiftTemplate.home.createOrEditLabel" data-cy="ShiftTemplateCreateUpdateHeading">
            <Translate contentKey="rosterv1App.shiftTemplate.home.createOrEditLabel">Create or edit a ShiftTemplate</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('rosterv1App.shiftTemplate.key')}
              ...
              />
              <ValidatedField
                label={translate('rosterv1App.shiftTemplate.shiftStart')}
              ...
              />
              <ValidatedField
                label={translate('rosterv1App.shiftTemplate.shiftEnd')}
              ...
              />
              <ValidatedField
                label={translate('rosterv1App.shiftTemplate.type')}
