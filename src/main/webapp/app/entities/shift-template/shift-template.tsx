  ...
  return (
    <div>
      <h2 id="shift-template-heading" data-cy="ShiftTemplateHeading">
        <Translate contentKey="rosterv1App.shiftTemplate.home.title">Shift Templates</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="rosterv1App.shiftTemplate.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/shift-template/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="rosterv1App.shiftTemplate.home.createLabel">Create new Shift Template</Translate>
          </Link>
        </div>
      </h2>
        ...
        {shiftTemplateList && shiftTemplateList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="rosterv1App.shiftTemplate.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('key')}>
                  <Translate contentKey="rosterv1App.shiftTemplate.key">Key</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('key')} />
                </th>
                <th className="hand" onClick={sort('shiftStart')}>
                  <Translate contentKey="rosterv1App.shiftTemplate.shiftStart">Shift Start</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('shiftStart')} />
                </th>
                <th className="hand" onClick={sort('shiftEnd')}>
                  <Translate contentKey="rosterv1App.shiftTemplate.shiftEnd">Shift End</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('shiftEnd')} />
                </th>
                <th className="hand" onClick={sort('type')}>
                  <Translate contentKey="rosterv1App.shiftTemplate.type">Type</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="rosterv1App.shiftTemplate.home.notFound">No Shift Templates found</Translate>
            </div>
          )
        )}
      </div>
