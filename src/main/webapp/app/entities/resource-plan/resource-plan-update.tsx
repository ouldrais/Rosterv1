  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rosterv1App.resourcePlan.home.createOrEditLabel" data-cy="ResourcePlanCreateUpdateHeading">
            <Translate contentKey="rosterv1App.resourcePlan.home.createOrEditLabel">Create or edit a ResourcePlan</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('rosterv1App.resourcePlan.availability')}
              ...
              <ValidatedField
                ...
                name="resource"
                data-cy="resource"
                label={translate('rosterv1App.resourcePlan.resource')}
                type="select"
              >
                <option value="" key="0" />
                {resources
              ...
              <ValidatedField
                ...
                name="shift"
                data-cy="shift"
                label={translate('rosterv1App.resourcePlan.shift')}
                type="select"
              >
                <option value="" key="0" />
                {shifts
              ...
              <ValidatedField
                ...
                name="position"
                data-cy="position"
                label={translate('rosterv1App.resourcePlan.position')}
                type="select"
              >
                <option value="" key="0" />
                {positions
