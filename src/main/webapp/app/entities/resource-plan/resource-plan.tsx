  ...
  return (
    <div>
      <h2 id="resource-plan-heading" data-cy="ResourcePlanHeading">
        <Translate contentKey="rosterv1App.resourcePlan.home.title">Resource Plans</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="rosterv1App.resourcePlan.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/resource-plan/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterv1App.resourcePlan.home.createLabel">Create new Resource Plan</Translate>
          </Link>
        </div>
      </h2>
        ...
        {resourcePlanList && resourcePlanList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="rosterv1App.resourcePlan.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('availability')}>
                  <Translate contentKey="rosterv1App.resourcePlan.availability">Availability</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('availability')} />
                </th>
                <th>
                  <Translate contentKey="rosterv1App.resourcePlan.resource">Resource</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="rosterv1App.resourcePlan.shift">Shift</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="rosterv1App.resourcePlan.position">Position</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="rosterv1App.resourcePlan.home.notFound">No Resource Plans found</Translate>
            </div>
          )
        )}
      </div>
