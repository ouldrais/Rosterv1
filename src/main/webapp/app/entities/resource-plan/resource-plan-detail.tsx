    ...
    <Row>
      <Col md="8">
        <h2 data-cy="resourcePlanDetailsHeading">
          <Translate contentKey="rosterv1App.resourcePlan.detail.title">ResourcePlan</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="rosterv1App.resourcePlan.resource">Resource</Translate>
          </dt>
          <dd>{resourcePlanEntity.resource ? resourcePlanEntity.resource.key : ''}</dd>
          <dt>
            <Translate contentKey="rosterv1App.resourcePlan.shift">Shift</Translate>
          </dt>
          <dd>{resourcePlanEntity.shift ? resourcePlanEntity.shift.key : ''}</dd>
          <dt>
            <Translate contentKey="rosterv1App.resourcePlan.position">Position</Translate>
          </dt>
