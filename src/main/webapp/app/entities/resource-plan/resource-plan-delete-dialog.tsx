...
export const ResourcePlanDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rosterv1App.resourcePlan.delete.question">
        <Translate contentKey="rosterv1App.resourcePlan.delete.question" interpolate={{ id: resourcePlanEntity.id }}>
