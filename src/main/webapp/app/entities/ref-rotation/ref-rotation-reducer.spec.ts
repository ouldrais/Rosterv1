...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REFROTATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_REFROTATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REFROTATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REFROTATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REFROTATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REFROTATION actions', async () => {
      const expectedActions = [
        {
