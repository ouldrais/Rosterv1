  ...
  return (
    <div>
      <h2 id="resource-training-heading" data-cy="ResourceTrainingHeading">
        <Translate contentKey="rosterv1App.resourceTraining.home.title">Resource Trainings</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="rosterv1App.resourceTraining.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/resource-training/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="rosterv1App.resourceTraining.home.createLabel">Create new Resource Training</Translate>
          </Link>
        </div>
      </h2>
        ...
        {resourceTrainingList && resourceTrainingList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="rosterv1App.resourceTraining.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('status')}>
                  <Translate contentKey="rosterv1App.resourceTraining.status">Status</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('status')} />
                </th>
                <th className="hand" onClick={sort('level')}>
                  <Translate contentKey="rosterv1App.resourceTraining.level">Level</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('level')} />
                </th>
                <th className="hand" onClick={sort('trainer')}>
                  <Translate contentKey="rosterv1App.resourceTraining.trainer">Trainer</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('trainer')} />
                </th>
                <th className="hand" onClick={sort('activeFrom')}>
                  <Translate contentKey="rosterv1App.resourceTraining.activeFrom">Active From</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('activeFrom')} />
                </th>
                <th className="hand" onClick={sort('activeto')}>
                  <Translate contentKey="rosterv1App.resourceTraining.activeto">Activeto</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('activeto')} />
                </th>
                <th>
                  <Translate contentKey="rosterv1App.resourceTraining.resource">Resource</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="rosterv1App.resourceTraining.training">Training</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="rosterv1App.resourceTraining.home.notFound">No Resource Trainings found</Translate>
            </div>
          )
        )}
      </div>
