...
export const ResourceTrainingDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rosterv1App.resourceTraining.delete.question">
        <Translate contentKey="rosterv1App.resourceTraining.delete.question" interpolate={{ id: resourceTrainingEntity.id }}>
