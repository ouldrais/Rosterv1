    ...
    <Row>
      <Col md="8">
        <h2 data-cy="resourceTrainingDetailsHeading">
          <Translate contentKey="rosterv1App.resourceTraining.detail.title">ResourceTraining</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="rosterv1App.resourceTraining.resource">Resource</Translate>
          </dt>
          <dd>{resourceTrainingEntity.resource ? resourceTrainingEntity.resource.key : ''}</dd>
          <dt>
            <Translate contentKey="rosterv1App.resourceTraining.training">Training</Translate>
          </dt>
