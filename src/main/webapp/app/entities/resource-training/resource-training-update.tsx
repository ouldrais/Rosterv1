  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rosterv1App.resourceTraining.home.createOrEditLabel" data-cy="ResourceTrainingCreateUpdateHeading">
            <Translate contentKey="rosterv1App.resourceTraining.home.createOrEditLabel">Create or edit a ResourceTraining</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('rosterv1App.resourceTraining.status')}
              ...
              />
              <ValidatedField
                label={translate('rosterv1App.resourceTraining.level')}
              ...
              />
              <ValidatedField
                label={translate('rosterv1App.resourceTraining.trainer')}
              ...
              />
              <ValidatedField
                label={translate('rosterv1App.resourceTraining.activeFrom')}
              ...
              />
              <ValidatedField
                label={translate('rosterv1App.resourceTraining.activeto')}
              ...
              <ValidatedField
                ...
                name="resource"
                data-cy="resource"
                label={translate('rosterv1App.resourceTraining.resource')}
                type="select"
              >
                <option value="" key="0" />
                {resources
              ...
              <ValidatedField
                ...
                name="training"
                data-cy="training"
                label={translate('rosterv1App.resourceTraining.training')}
                type="select"
              >
                <option value="" key="0" />
                {trainings
