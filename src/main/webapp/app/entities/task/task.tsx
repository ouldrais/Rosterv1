  ...
  return (
    <div>
      <h2 id="task-heading" data-cy="TaskHeading">
        <Translate contentKey="rosterv1App.task.home.title">Tasks</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="rosterv1App.task.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/task/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterv1App.task.home.createLabel">Create new Task</Translate>
          </Link>
        </div>
      </h2>
        ...
        {taskList && taskList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('key')}>
                  <Translate contentKey="rosterv1App.task.key">Key</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('key')} />
                </th>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="rosterv1App.task.id">Id</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="rosterv1App.task.home.notFound">No Tasks found</Translate>
            </div>
          )
        )}
      </div>
