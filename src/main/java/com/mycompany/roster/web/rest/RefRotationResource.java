...
import com.mycompany.roster.repository.RefRotationRepository;
...
/**
 * REST controller for managing {@link com.mycompany.roster.domain.RefRotation}.
 */
@RestController
...
public class RefRotationResource {
    ...
    public ResponseEntity<RefRotation> getRefRotation(@PathVariable("id") Long id) {
        ...
        Optional<RefRotation> refRotation = refRotationRepository.findById(id);
